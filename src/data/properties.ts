...
export const properties: Property[] = [
    ...
    history: [
      {
        ...
        description: "Cadastro inicial na plataforma AlugaFlow.",
  ...
  },
  {
    ...
    owner,
    units: [
      { id: "u-301", label: "Apto 301", status: "ocupado", bedrooms: 2, rent: 3200, tenantName: "Ana Rocha" },
      { id: "u-302", label: "Apto 302", status: "ocupado", bedrooms: 2, rent: 3200, tenantName: "Bruno Lima" },
      { id: "u-401", label: "Apto 401", status: "disponivel", bedrooms: 3, rent: 4200 },
      { id: "u-402", label: "Apto 402", status: "ocupado", bedrooms: 3, rent: 4200, tenantName: "Célia Matos" },
